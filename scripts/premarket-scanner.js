#!/usr/bin/env node
// PRE-MARKET SCANNER v6 - ACCUMULATION FIRST
// Core Strategy: Find stocks PUSHED DOWN with volume UP = smart money buying
...
async function scan() {
  console.log('PRE-MARKET SCANNER v6 - ACCUMULATION FIRST');
  console.log('============================================');
  console.log('🎯 Strategy: Find stocks PUSHED DOWN with volume UP = smart money buying\n');
